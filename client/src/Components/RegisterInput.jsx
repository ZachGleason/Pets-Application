  ...
  <div style={{ height: 800, width: "60%", margin: "auto", marginTop: "8%", borderRadius: 20}}   >
    <Form >
      ...
      <Form.Label style={{ marginTop: 30}}>First Name</Form.Label>
        <InputGroup className="mb-1" onChange={ e => setFirstname(e.target.value)}>
        ...
        <InputGroup className="mb-1" onChange={ e => setLastname(e.target.value)}>
            <InputGroup.Text><FiStar /></InputGroup.Text>
            <Form.Control id="inlineFormInputGroup" placeholder="Last Name" />
          </InputGroup>
        <Form.Label style={{ marginTop: 30}}>Email address</Form.Label>
        <InputGroup className="mb-1" onChange={ e => setEmail(e.target.value)}>
      ...
      <Button onClick={handleRegistration} sx={{backgroundColor: "black !important", color: "white", background: 'none', width: "100%", marginTop: 1, height: 30 }}>Register</Button>
      <h5>or</h5>
